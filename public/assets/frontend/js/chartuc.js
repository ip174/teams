...
function drawCharts(){
  ...
  */
  ...
  var barData = google.visualization.arrayToDataTable([
    ['Day', 'Profile view corrent month', 'Last month'],
    ['Sun',  profileViews[0], lastMonthprofileViews[0]],
    ['Mon',  profileViews[1], lastMonthprofileViews[1]],
    ['Tue',  profileViews[2], lastMonthprofileViews[2]],
    ['Wed',  profileViews[3], lastMonthprofileViews[3]],
    ['Thu',  profileViews[4], lastMonthprofileViews[4]],
    ['Fri',  profileViews[5], lastMonthprofileViews[5]],
    ['Sat',  profileViews[6], lastMonthprofileViews[6]]
  ]);
  ...
  */
  ...
  var pieOptions = {
    ...
    pieHole: 0.4,
    colors: [ 
      "cornflowerblue", "olivedrab", "orange", "tomato", 
      "crimson", "purple", "turquoise", "forestgreen", 
      "navy", "gray"
    ],
    pieSliceText: 'value',
    tooltip: {
